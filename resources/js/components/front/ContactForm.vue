...
<template>
  ...
  <section
    v-if="readyToLoad"
    id="contact"
    class="px-6 py-20 bg-[#112240] text-[#ccd6f6]"
    data-aos="fade-up"
  >
    ...
    <div
      v-if="formSubmitted"
      ref="successMessage"
      class="text-center text-lg text-green-400"
    >
      {{ page.props.flash.success }}
    </div>

    <div
      v-if="form.hasErrors && form.errors.general"
      class="text-red-400 text-center mb-4"
    >
      {{ form.errors.general }}
    </div>
    ...
    <form
      ...
      class="max-w-xl mx-auto grid gap-4"
    >
      <div>
        <Input
          id="fullname"
