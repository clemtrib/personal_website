...
Route::prefix('experiences')->group(function () {
    ...
    Route::get('/{experience}', [WorkExperienceController::class, 'show'])->name('experiences.show');
    Route::put('/{experience}', [WorkExperienceController::class, 'update'])->name('experiences.update');
    Route::delete('/{experience}', [WorkExperienceController::class, 'destroy'])->name('experiences.destroy');
});
